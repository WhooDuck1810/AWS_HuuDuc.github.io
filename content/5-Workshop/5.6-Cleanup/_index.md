...
# 6. Difficulties & Development Direction

## 6.1 Difficulties Encountered

### 6.1.1 Windows vs. Linux Path Issue in React Router Build
...
### 6.1.2 EC2 Free Tier Memory Constraint
...
### 6.1.3 CloudFront Account Verification Requirement
...
### 6.1.4 RDS Private Subnet Connectivity
...
### 6.1.5 WebSocket CORS Issues Behind Proxy
...
## 6.2 Development Direction & Future Roadmap

### 6.2.1 Multi-Region Active-Active Deployment
...
### 6.2.2 Amazon CloudFront CDN Integration
...
### 6.2.3 Amazon Aurora Global Database
...
### 6.2.4 Infrastructure as Code with AWS CDK
...
### 6.2.5 Auto Scaling Group with Application Load Balancer
...
### 6.2.6 Advanced Monitoring with CloudWatch Dashboards
...
### 6.2.7 Periodic Maintenance Scheduler with AWS EventBridge
